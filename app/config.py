...
NOMBRES_SERIES = {
    ...
    "pib_chile": "PIB Chile (miles de millones de $ CORRIENTES, trimestral, desestacionalizado)",
    ...
    "pib_mineria": "PIB Minería (miles de millones de $ reales, mensual, desestacionalizado)",
    "pib_no_minero": "PIB No minero (miles de millones de $ reales, trimestral, desestacionalizado)",
...
DEFINICIONES = {
    ...
    "pib_chile": "Valor de todos los bienes y servicios producidos en Chile en el trimestre, a precios de mercado CORRIENTES (nominal, sin descontar inflación) — no confundir con una medida de crecimiento real. Para ver la parte del PIB que sí está en términos reales (deflactados), ver 'PIB Minería' y 'PIB No minero' más abajo, o el IMACEC. No es comparable en magnitud con las cifras 'per cápita' en dólares de más abajo — son unidades distintas.",
    ...
    "chile_poblacion": "Población total de Chile, fuente Banco Mundial (dato anual). Se usa, entre otras cosas, para calcular el IMACEC per cápita más abajo -- los meses sin dato anual todavía se interpolan/extrapolan linealmente, ver series_utils.calcular_poblacion_mensual_interpolada.",
